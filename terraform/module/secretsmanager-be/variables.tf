...
variable "sqs_secretsmanager_name" {
  type        = string
  default     = ""
  description = "Secrets manager secret name"
}

variable "opensearch_secretsmanager_name" {
  type        = string
  default     = ""
  description = "opensearch secrets manager secret name"
}

variable "elasticache_secretsmanager_name" {
  type        = string
  default     = ""
  description = "elasticache secrets manager secret name"
}

variable "rds_secretsmanager_name" {
  type        = string
  default     = ""
  description = "rds secrets manager secret name"
}
