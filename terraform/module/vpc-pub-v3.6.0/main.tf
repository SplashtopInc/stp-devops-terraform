...
resource "aws_vpc" "this" {
  ...
  # checkov:skip=CKV2_AWS_11: WILL ATTACH TO ALB IN HELM
  # checkov:skip=CKV2_AWS_12: WILL ATTACH TO ALB IN HELM
  cidr_block                       = var.cidr
...
resource "aws_subnet" "public" {
  ...
  # checkov:skip=CKV_AWS_130: WILL ATTACH TO ALB IN HELM
  vpc_id                          = local.vpc_id
...
resource "aws_eip" "nat" {
  ...
  # checkov:skip=CKV2_AWS_19: WILL ATTACH TO ALB IN HELM
  vpc = true
