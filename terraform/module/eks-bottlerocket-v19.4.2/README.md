...
| <a name="input_runner_desired_size"></a> [runner\_desired\_size](#input\_runner\_desired\_size) | The number of Amazon EC2 instances that should be running in the autoscaling group | `number` | `1` | no |
| <a name="input_runner_instance_types"></a> [runner\_instance\_types](#input\_runner\_instance\_types) | (Optional) List of instance types associated with the EKS Node Group. | `list(object({ instance_type = string }))` | <pre>[<br>  {<br>    "instance_type": "m5.large"<br>  },<br>  {<br>    "instance_type": "m4.large"<br>  },<br>  {<br>    "instance_type": "t3.large"<br>  },<br>  {<br>    "instance_type": "t2.large"<br>  }<br>]</pre> | no |
| <a name="input_runner_max_size"></a> [runner\_max\_size](#input\_runner\_max\_size) | (Required) The maximum size of the Auto Scaling Group. | `number` | `5` | no |
| <a name="input_runner_min_size"></a> [runner\_min\_size](#input\_runner\_min\_size) | (Required) The minimum size of the Auto Scaling Group | `number` | `1` | no |
| <a name="input_runner_on_demand_base_capacity"></a> [runner\_on\_demand\_base\_capacity](#input\_runner\_on\_demand\_base\_capacity) | (Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0 | `number` | `0` | no |
| <a name="input_runner_on_demand_percentage"></a> [runner\_on\_demand\_percentage](#input\_runner\_on\_demand\_percentage) | (Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100 | `number` | `100` | no |
...
| <a name="input_sonarqube_desired_size"></a> [sonarqube\_desired\_size](#input\_sonarqube\_desired\_size) | The number of Amazon EC2 instances that should be running in the autoscaling group | `number` | `1` | no |
| <a name="input_sonarqube_instance_types"></a> [sonarqube\_instance\_types](#input\_sonarqube\_instance\_types) | (Optional) List of instance types associated with the EKS Node Group. | `list(object({ instance_type = string }))` | <pre>[<br>  {<br>    "instance_type": "m5.large"<br>  },<br>  {<br>    "instance_type": "m4.large"<br>  },<br>  {<br>    "instance_type": "t3.large"<br>  },<br>  {<br>    "instance_type": "t2.large"<br>  }<br>]</pre> | no |
| <a name="input_sonarqube_max_size"></a> [sonarqube\_max\_size](#input\_sonarqube\_max\_size) | (Required) The maximum size of the Auto Scaling Group. | `number` | `5` | no |
| <a name="input_sonarqube_min_size"></a> [sonarqube\_min\_size](#input\_sonarqube\_min\_size) | (Required) The minimum size of the Auto Scaling Group | `number` | `1` | no |
| <a name="input_sonarqube_on_demand_base_capacity"></a> [sonarqube\_on\_demand\_base\_capacity](#input\_sonarqube\_on\_demand\_base\_capacity) | (Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0 | `number` | `0` | no |
| <a name="input_sonarqube_on_demand_percentage"></a> [sonarqube\_on\_demand\_percentage](#input\_sonarqube\_on\_demand\_percentage) | (Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100 | `number` | `100` | no |
