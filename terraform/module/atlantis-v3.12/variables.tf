...
variable "atlantis_github_user_token_ssm_parameter_name" {
  ...
  type        = string
  default     = "/atlantis/github/user/token" #tfsec:ignore:general-secrets-no-plaintext-exposure
}
...
variable "atlantis_gitlab_user_token_ssm_parameter_name" {
  ...
  type        = string
  default     = "/atlantis/gitlab/user/token" #tfsec:ignore:general-secrets-no-plaintext-exposure
}
...
variable "atlantis_bitbucket_user_token_ssm_parameter_name" {
  ...
  type        = string
  default     = "/atlantis/bitbucket/user/token" #tfsec:ignore:general-secrets-no-plaintext-exposure
}
...
# https://github.com/terraform-aws-modules/terraform-aws-atlantis/blob/master/examples/github-complete/variables.tf
# Github
