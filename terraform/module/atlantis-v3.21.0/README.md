...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_atlantis"></a> [atlantis](#module\_atlantis) | terraform-aws-modules/atlantis/aws | 3.21.0 |
...
| <a name="input_allowed_repo_names"></a> [allowed\_repo\_names](#input\_allowed\_repo\_names) | repo name | `list(string)` | `[]` | no |
...
| <a name="input_profile"></a> [profile](#input\_profile) | ## aws | `string` | `""` | no |
