...
variable "name" {
  type    = string
  default = "stp-vpc-admin"
}
variable "vpc_admin_az_start" {
  type    = number
  default = 0
}
variable "vpc_admin_az_end" {
  type    = number
  default = 3
}
# Public
variable "vpc_admin_cidr" {
  type    = string
  default = "172.26.0.0/16"
}
variable "vpc_admin_pri_subnets" {
  type = list(string)
  default = [
    "172.26.16.0/23",
    "172.26.18.0/23",
...
variable "vpc_admin_pub_subnets" {
  type = list(string)
  default = [
    "172.26.0.0/23",
    "172.26.2.0/23",
...
variable "vpc_admin_reuse_nat_ips" {
  type    = bool
  default = false
}

variable "vpc_admin_nat_eip_ids" {
  type = list(string)
  default = [
