locals {
  secretsmanager_json = {
    ...
    "LOG_RDS_HOST"          = "${var.db2_rds_endpoint}",
    "LOG_RDS_PASSWORD"      = "${var.log_rds_password}",
    "LOG_RDS_USER"          = "${var.log_rds_user}",
    "LOG_READONLY_RDS_HOST" = "${var.db2_rds_readonly_endpoint}",
    #MS_TEAMS
    "MS_TEAMS_APP_ID"       = "",
    "MS_TEAMS_BOT_ID"       = "",
    ...
    #RDS_ANALYSIS
    "RDS_ANALYSIS_DB2_HOST" = "${var.db2_rds_readonly_endpoint}",
    "RDS_ANALYSIS_HOST"     = "${var.db2_rds_readonly_endpoint}",
    #RDS
    "RDS_DATABASE"    = "${var.rds_database}",
    "RDS_HOST"        = "${var.db1_rds_endpoint}",
    "RDS_PASSWORD"    = "${var.rds_password}",
    "RDS_USER"        = "${var.rds_user}",
    "RDS_OREGON_HOST" = "${var.db1_rds_readonly_endpoint}",
    #RDS_READONLY
    "RDS_READONLY_DATABASE" = "${var.rds_readonly_database}",
    "RDS_READONLY_HOST"     = "${var.db1_rds_readonly_endpoint}",
    ...
    "RECAPTCHA_SITE_KEY"   = "",
    #REDIS
    "REDIS_MASTER_URL"     = "${var.master_redis_address}",
    "REDIS_NOAOF_URL"      = "${var.noaof_redis_address}",
    "REDIS_TIMEOUT_URL"    = "${var.timeout_redis_address}",
    "REDIS_WEBSOCKET_URL"  = "${var.websocket_redis_address}",
    ...
    "SES_SMTP_USERNAME" = "",
    #SQS
    "SQS_SRC_COMMAND"      = "${var.src_command}",
