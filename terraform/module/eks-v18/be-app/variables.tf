...
# Be app
################################################################################
variable "be_api_instance_types" {
...
variable "be_api_max_size" {
  description = "(Required) The maximum size of the Auto Scaling Group."
  type        = number
  default     = 5
}
variable "be_api_min_size" {
  description = "(Required) The minimum size of the Auto Scaling Group"
  type        = number
  default     = 3
}
variable "be_api_desired_size" {
  description = "The number of Amazon EC2 instances that should be running in the autoscaling group"
  type        = number
  default     = 3
}
variable "be_api_on_demand_size" {
  description = ""
  type        = number
  default     = 3
}
variable "be_api_on_demand_base_capacity" {
...
variable "be_my_max_size" {
  description = "(Required) The maximum size of the Auto Scaling Group."
  type        = number
  default     = 5
}
variable "be_my_min_size" {
  description = "(Required) The minimum size of the Auto Scaling Group"
  type        = number
  default     = 3
}
variable "be_my_desired_size" {
  description = "The number of Amazon EC2 instances that should be running in the autoscaling group"
  type        = number
  default     = 3
}
variable "be_my_on_demand_size" {
  description = ""
  type        = number
  default     = 3
}
variable "be_my_on_demand_base_capacity" {
  description = "(Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0"
  type        = number
  default     = 0
}
variable "be_my_on_demand_percentage" {
  type        = number
  default     = 100
  description = "(Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100"
}
variable "be_my_kubelet_args" {
...
# Be devops
################################################################################
variable "be_devops_instance_types" {
  description = "(Optional) List of instance types associated with the EKS Node Group."
  type        = list(object({ instance_type = string }))
  default = [
    {
...
variable "be_devops_max_size" {
  description = "(Required) The maximum size of the Auto Scaling Group."
  type        = number
  default     = 5
}
variable "be_devops_min_size" {
  description = "(Required) The minimum size of the Auto Scaling Group"
  type        = number
  default     = 1
}
variable "be_devops_desired_size" {
  description = "The number of Amazon EC2 instances that should be running in the autoscaling group"
  type        = number
  default     = 1
}
variable "be_devops_on_demand_size" {
  description = ""
  type        = number
  default     = 0
}
variable "be_devops_on_demand_base_capacity" {
  description = "(Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0"
  type        = number
  default     = 0
}
...
variable "be_devops_kubelet_args" {
