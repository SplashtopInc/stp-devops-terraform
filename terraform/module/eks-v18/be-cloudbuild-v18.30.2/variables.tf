...
variable "cb_others_on_demand_size" {
  description = ""
  type        = number
  default     = 0
}
...
variable "cb_others_kubelet_args" {
  description = "kubelet arguments for CloudBuild others work group"
  type        = string
  default     = "--node-labels=node.kubernetes.io/lifecycle=spot,app=cloudbuild-others"
}
################################################################################
# CloudBuild - Builder for WINE (MSI & EXE)
################################################################################
...
variable "cb_wine_on_demand_size" {
  description = ""
  type        = number
  default     = 3
}
...
variable "cb_wine_kubelet_args" {
  description = "kubelet arguments for CloudBuild wine work group"
  type        = string
  default     = "--node-labels=node.kubernetes.io/lifecycle=spot,app=cloudbuild-wine"
}
################################################################################
# CloudBuild - DevOps for system wide usage
################################################################################
...
variable "cb_devops_on_demand_size" {
  description = ""
  type        = number
  default     = 0
}
...
variable "cb_devops_kubelet_args" {
  description = "kubelet arguments for CloudBuild devops work group"
  type        = string
  default     = "--node-labels=node.kubernetes.io/lifecycle=spot,app=cloudbuild-devops"
}
##################################################################
### Services name ###
##################################################################
