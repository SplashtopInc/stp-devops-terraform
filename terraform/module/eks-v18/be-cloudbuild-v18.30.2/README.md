...
| <a name="input_cb_devops_kubelet_args"></a> [cb\_devops\_kubelet\_args](#input\_cb\_devops\_kubelet\_args) | kubelet arguments for CloudBuild devops work group | `string` | `"--node-labels=node.kubernetes.io/lifecycle=spot,app=cloudbuild-devops"` | no |
...
| <a name="input_cb_devops_on_demand_size"></a> [cb\_devops\_on\_demand\_size](#input\_cb\_devops\_on\_demand\_size) | n/a | `number` | `0` | no |
...
| <a name="input_cb_others_kubelet_args"></a> [cb\_others\_kubelet\_args](#input\_cb\_others\_kubelet\_args) | kubelet arguments for CloudBuild others work group | `string` | `"--node-labels=node.kubernetes.io/lifecycle=spot,app=cloudbuild-others"` | no |
...
| <a name="input_cb_others_on_demand_size"></a> [cb\_others\_on\_demand\_size](#input\_cb\_others\_on\_demand\_size) | n/a | `number` | `0` | no |
...
| <a name="input_cb_wine_kubelet_args"></a> [cb\_wine\_kubelet\_args](#input\_cb\_wine\_kubelet\_args) | kubelet arguments for CloudBuild wine work group | `string` | `"--node-labels=node.kubernetes.io/lifecycle=spot,app=cloudbuild-wine"` | no |
...
| <a name="input_cb_wine_on_demand_percentage"></a> [cb\_wine\_on\_demand\_percentage](#input\_cb\_wine\_on\_demand\_percentage) | (Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100 | `number` | `0` | no |
| <a name="input_cb_wine_on_demand_size"></a> [cb\_wine\_on\_demand\_size](#input\_cb\_wine\_on\_demand\_size) | n/a | `number` | `3` | no |
...
| <a name="output_cloudbuild_node_ami"></a> [cloudbuild\_node\_ami](#output\_cloudbuild\_node\_ami) | cloudbuild\_node\_ami |
