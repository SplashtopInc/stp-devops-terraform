...
output "eks-cloudbuild" {
  description = "Abstract of cloudbuild eks"
  value = {
    "cluster_id"           = module.eks.cluster_id
    "cluster_endpoint"     = module.eks.cluster_endpoint
    "cluster_iam_role_arn" = module.eks.cluster_iam_role_arn
    "cluster_vpc_id"       = local.vpc_id
    "cluster_subnet_ids"   = local.subnet_ids
    "worker_ami_linux"     = local.cb_worker_ami_linux
  }
}