...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_eks"></a> [eks](#module\_eks) | terraform-aws-modules/eks/aws | 18.20.4 |

## Resources

| Name | Type |
|------|------|
| [aws_iam_policy.allow_firehose_r53_autoscaling_s3_sns](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
| [aws_iam_policy.aws_load_balancer_controller_cb](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_role_policy_attachment.attach-2-eks-worker-role-albingress](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.attach-2-eks-worker-role-externaldns](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.attach-aws-cloudwatchagent-policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_ami.cloudbuild_node_ami](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ami) | data source |
...
| [aws_iam_policy_document.allow_firehose_r53_autoscaling_s3_sns](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.aws_load_balancer_controller_cb](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| [aws_vpc.stp-vpc-backend](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/vpc) | data source |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_account"></a> [account](#input\_account) | n/a | `string` | `"(Optional) The ID of the target account when managing member accounts. "` | no |
| <a name="input_app_service"></a> [app\_service](#input\_app\_service) | ## Services name ### | `string` | `"app"` | no |
| <a name="input_assume_role"></a> [assume\_role](#input\_assume\_role) | n/a | `string` | `"(Optional) Configuration block for assuming an IAM role. See the assume_role Configuration Block section below. Only one assume_role block may be in the configuration."` | no |
...
| <a name="input_aws_account_name"></a> [aws\_account\_name](#input\_aws\_account\_name) | n/a | `string` | `"(Optional) The name of the AWS account"` | no |
| <a name="input_cb_devops_desired_size"></a> [cb\_devops\_desired\_size](#input\_cb\_devops\_desired\_size) | The number of Amazon EC2 instances that should be running in the autoscaling group | `number` | `1` | no |
| <a name="input_cb_devops_instance_types"></a> [cb\_devops\_instance\_types](#input\_cb\_devops\_instance\_types) | (Optional) List of instance types associated with the EKS Node Group. | `list(object({ instance_type = string }))` | <pre>[<br>  {<br>    "instance_type": "m5.large"<br>  },<br>  {<br>    "instance_type": "m4.large"<br>  },<br>  {<br>    "instance_type": "t3.large"<br>  },<br>  {<br>    "instance_type": "t2.large"<br>  }<br>]</pre> | no |
| <a name="input_cb_devops_max_size"></a> [cb\_devops\_max\_size](#input\_cb\_devops\_max\_size) | (Required) The maximum size of the Auto Scaling Group. | `number` | `5` | no |
| <a name="input_cb_devops_min_size"></a> [cb\_devops\_min\_size](#input\_cb\_devops\_min\_size) | (Required) The minimum size of the Auto Scaling Group | `number` | `1` | no |
| <a name="input_cb_devops_on_demand_base_capacity"></a> [cb\_devops\_on\_demand\_base\_capacity](#input\_cb\_devops\_on\_demand\_base\_capacity) | (Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0 | `number` | `0` | no |
| <a name="input_cb_devops_on_demand_percentage"></a> [cb\_devops\_on\_demand\_percentage](#input\_cb\_devops\_on\_demand\_percentage) | (Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100 | `number` | `100` | no |
| <a name="input_cb_kubelet_args_devops"></a> [cb\_kubelet\_args\_devops](#input\_cb\_kubelet\_args\_devops) | kubelet arguments for devops work group | `string` | `""` | no |
| <a name="input_cb_kubelet_args_others"></a> [cb\_kubelet\_args\_others](#input\_cb\_kubelet\_args\_others) | kubelet arguments for other work group | `string` | `""` | no |
| <a name="input_cb_kubelet_args_wine"></a> [cb\_kubelet\_args\_wine](#input\_cb\_kubelet\_args\_wine) | kubelet arguments for wine work group | `string` | `""` | no |
| <a name="input_cb_others_desired_size"></a> [cb\_others\_desired\_size](#input\_cb\_others\_desired\_size) | The number of Amazon EC2 instances that should be running in the autoscaling group | `number` | `3` | no |
| <a name="input_cb_others_instance_types"></a> [cb\_others\_instance\_types](#input\_cb\_others\_instance\_types) | (Optional) List of instance types associated with the EKS Node Group. | `list(object({ instance_type = string }))` | <pre>[<br>  {<br>    "instance_type": "m5.large"<br>  },<br>  {<br>    "instance_type": "m4.large"<br>  },<br>  {<br>    "instance_type": "t3.large"<br>  },<br>  {<br>    "instance_type": "t2.large"<br>  }<br>]</pre> | no |
| <a name="input_cb_others_max_size"></a> [cb\_others\_max\_size](#input\_cb\_others\_max\_size) | (Required) The maximum size of the Auto Scaling Group. | `number` | `5` | no |
| <a name="input_cb_others_min_size"></a> [cb\_others\_min\_size](#input\_cb\_others\_min\_size) | (Required) The minimum size of the Auto Scaling Group | `number` | `3` | no |
| <a name="input_cb_others_on_demand_base_capacity"></a> [cb\_others\_on\_demand\_base\_capacity](#input\_cb\_others\_on\_demand\_base\_capacity) | (Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0 | `number` | `0` | no |
| <a name="input_cb_others_on_demand_percentage"></a> [cb\_others\_on\_demand\_percentage](#input\_cb\_others\_on\_demand\_percentage) | (Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100 | `number` | `100` | no |
| <a name="input_cb_wine_desired_size"></a> [cb\_wine\_desired\_size](#input\_cb\_wine\_desired\_size) | The number of Amazon EC2 instances that should be running in the autoscaling group | `number` | `3` | no |
| <a name="input_cb_wine_instance_types"></a> [cb\_wine\_instance\_types](#input\_cb\_wine\_instance\_types) | (Optional) List of instance types associated with the EKS Node Group. | `list(object({ instance_type = string }))` | <pre>[<br>  {<br>    "instance_type": "m5.large"<br>  },<br>  {<br>    "instance_type": "m4.large"<br>  },<br>  {<br>    "instance_type": "t3.large"<br>  },<br>  {<br>    "instance_type": "t2.large"<br>  }<br>]</pre> | no |
| <a name="input_cb_wine_max_size"></a> [cb\_wine\_max\_size](#input\_cb\_wine\_max\_size) | (Required) The maximum size of the Auto Scaling Group. | `number` | `5` | no |
| <a name="input_cb_wine_min_size"></a> [cb\_wine\_min\_size](#input\_cb\_wine\_min\_size) | (Required) The minimum size of the Auto Scaling Group | `number` | `3` | no |
| <a name="input_cb_wine_on_demand_base_capacity"></a> [cb\_wine\_on\_demand\_base\_capacity](#input\_cb\_wine\_on\_demand\_base\_capacity) | (Optional) Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: 0 | `number` | `0` | no |
| <a name="input_cb_wine_on_demand_percentage"></a> [cb\_wine\_on\_demand\_percentage](#input\_cb\_wine\_on\_demand\_percentage) | (Optional) Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100 | `number` | `100` | no |
...
| <a name="input_environment"></a> [environment](#input\_environment) | n/a | `string` | `"(Optional) The environment of eks"` | no |
...
| <a name="input_profile"></a> [profile](#input\_profile) | ############################################################################### Terragrunt input aws variable ############################################################################### | `string` | `"(Optional) AWS profile name as set in the shared configuration and credentials files. Can also be set using either the environment variables AWS_PROFILE or AWS_DEFAULT_PROFILE."` | no |
| <a name="input_project"></a> [project](#input\_project) | n/a | `string` | `"(Optional) The project of eks"` | no |
| <a name="input_putin_khuylo"></a> [putin\_khuylo](#input\_putin\_khuylo) | Do you agree that Putin doesn't respect Ukrainian sovereignty and territorial integrity? More info: https://en.wikipedia.org/wiki/Putin_khuylo! | `bool` | `true` | no |
| <a name="input_region"></a> [region](#input\_region) | n/a | `string` | `"(Optional) The AWS region where the provider will operate. The region must be set. Can also be set with either the AWS_REGION or AWS_DEFAULT_REGION environment variables, or via a shared config file parameter region if profile is used. If credentials are retrieved from the EC2 Instance Metadata Service, the region can also be retrieved from the metadata."` | no |
...
| <a name="output_eks-cloudbuild"></a> [eks-cloudbuild](#output\_eks-cloudbuild) | Abstract of cloudbuild eks |
